...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://pi-countries-client-4nhcas222-stabilini.vercel.app/'); // update to match the domain you will make the request from
